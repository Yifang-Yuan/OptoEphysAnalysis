...
folder ='G:/Jinghua_CB_EC5aFibre/1721126_day3/'
COLD_folder='G:/Jinghua_CB_EC5aFibre/workingfolder/'
# Set your parameters
COLD_filename='Training Data_Day3.xlsx'
pyFs=130
CamFs=24
#half_timewindow=1
...
df_py_cheese=fp.read_all_photometry_files(folder, '2024-04-','sync',CamFs,pyFs,COLD_folder,COLD_filename)
#%%
#Enter the value 
before_window=10
after_window=10
...
filename='1721126PETH_'+str(before_window)+'seconds_window.pkl'
