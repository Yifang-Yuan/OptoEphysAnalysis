...
def average_all_theta_phase_results(folder):
    # Path to your folder
...
calculate_theta_phase_session()
 #%%
folder = Path(r"G:\2025_ATLAS_SPAD\PVCre\1842515_PV_mNeon\aLocomotion_day7\ThetaPhase_Save")
average_all_theta_phase_results(folder)
