...
Fs=10000
dpath='F:/2025_ATLAS_SPAD/1881363_Jedi2p_mCherry/Day3/'
...
#theta_part,non_theta_part=Recording1.pynacollada_label_theta (LFP_channel,Low_thres=-0.7,High_thres=8,save=False,plot_theta=True)
...
OpticalAnlaysis.PSD_plot(sig_theta, Fs, method="welch", color='green', xlim=[0.5, 49], linewidth=2, linestyle='-', label='GEVI', ax=ax1)
OpticalAnlaysis.PSD_plot(ref_theta, Fs, method="welch", color='red', xlim=[0.5, 49],linewidth=2, linestyle='-', label='Ref', ax=ax1)
...
OpticalAnlaysis.PSD_plot(LFP_theta, Fs, method="welch", color='black', xlim=[0.5, 49], linewidth=2, linestyle='-', label='LFP  ', ax=ax2)
