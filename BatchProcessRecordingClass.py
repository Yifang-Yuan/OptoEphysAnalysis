...
def ReadOneDaySession (parent_folder,TargetfolderName='SyncRecording', IsTracking=False,
    ...
    for SyncRecordingName in sync_recording_folders:
        ...
        for i in range (1):
            ...
            Recording1.pynacollada_label_theta (LFP_channel,Low_thres=-0.3,High_thres=10)
            ...
            #                                                  ep_start=0,ep_end=50,Low_thres=-0.3,High_thres=10,
            ...
            # 'plot ripple heatmap'
            # savename='RippleSave'
            # plotRipple.run_ripple_plot (parent_folder,LFP_channel,SyncRecordingName,savename,theta_cutoff=0.1)
...
def main():    
    ...
    '''
    parent_folder=r'G:\2025_ATLAS_SPAD\PVCre\1844607_PV_mNeon_F\ALocomotion\Day4Day6Day7'
